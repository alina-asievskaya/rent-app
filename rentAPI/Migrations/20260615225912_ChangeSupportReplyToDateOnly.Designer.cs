...
namespace rentAPI.Migrations
{
    ...
    [Migration("20260615225912_ChangeSupportReplyToDateOnly")]
    partial class ChangeSupportReplyToDateOnly
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentApp.API.Models.Agent", b =>
                {
                    ...
                    b.Property<string>("PortfolioPhotos")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(4000)
            ...
            modelBuilder.Entity("RentApp.API.Models.CateringOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RentApp.API.Models.CateringOwner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CateringOwners", (string)null);
                });
            ...
            modelBuilder.Entity("RentApp.API.Models.HouseCatering", b =>
                {
                    ...
                    b.HasIndex("HouseId", "CateringOwnerId")
                        .IsUnique();
            ...
            modelBuilder.Entity("RentApp.API.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RentApp.API.Models.ServiceRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RentApp.API.Models.SupportReply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RentApp.API.Models.SupportReply", b =>
                {
                    b.HasOne("RentApp.API.Models.User", "Admin")
                        .WithMany()
                        .HasForeignKey("AdminId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RentApp.API.Models.Feedback", "Feedback")
                        .WithMany("Replies")
